...
function hidePersonalData1(){
	$("#personalinfoform").html("");
	$("#b2").html("<input type='button' onclick='fill()' class='btn btn-primary' value='Fill'/>");
}
...
function fill(){
	$.get("index.php?r=student/default/createuserdata", function(data){ $("#personalinfoform").html(data);});
	$("#b2").html("<input type='button' onclick='hidePersonalData1()' class='btn btn-primary' value='Hide'/>");
}
</script>