...
<div class="form2">
    ...
    <?= $form->field($model, 'department_id')->dropDownList([],['id' => 'dropdown_department','onchange' => 'getGroups($(this).val())', 'prompt' => '', 'onclick' => 'getGroups($(this).val())']) ?>
		
    <?= $form->field($model, 'group_id')->dropDownList([],['id' => 'dropdown_group']) ?>
...
function enterData(){
	...
	var url = "/sduportal/frontend/web/index.php?r=departmenthead/default/createuserdata";
